...
const infoList = [
  {
    name: "올해 탈출 가능할 듯 ~ 연애 뭐 식은 죽 먹기죠, 연애 재능 만땅 <쥐>",
  ...
  {
    name: " 케빈과 함께 할 타입 ~ 난 너만 봐, 정직한 연애 스타일의 <소>",
  ...
  {
    name: "지금이라도 탈츨~ 야 사귀자, 사랑을 쟁취하는 <호랑이>",
  ...
  {
    name: "본인 맘에 들어야 할 듯~ 어렵 이건 어때? 난 어때? 독특한 매력을 가진 <토끼>",
  ...
  {
    name: "벌서부터,,,케빈과 함께할 확률이 높아요 ~ 결혼은 언제쯤 할까 신혼여행은 어디로?, 이상적인 연애관의 소유자 <용>",
  ...
  {
    name: "벌써부터 기념일에 무슨 이벤트 할까 빛이 나는 솔로 ~ 이벤트 플래너 <뱀>",
  ...
  {
    name: "어 오늘 머리 바꿨네 잘 어울린다, 솔로 당신  센스가 뛰어난 <말>",
  ...
  {
    name: "환승연애 ~ 메기 같은 당신 난 너랑 하는 것들 다 좋아, 순종적인 <양>",
  ...
  {
    name: "끼쟁이 ~ 탈출 난 당신의 연예인, 끼가 넘치는 재주꾼 <원숭이>",
  ...
  {
    name: "희두 같은 당신 이건 이거고 저건 저거지 , 공과사 확실한 <닭>",
  ...
  {
    name: "혹시 환승연애 나연님 타입 ..? 난 네가 좋아 너무 좋아, 애교만땅 <개>",
  ...
  {
    name: "올해는 어렵네요 .. 산은 산이요 연애는 연애로다, 느긋하고 온순한 <돼지>",
